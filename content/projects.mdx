...
As such, their mainly user-facing.
...
of a Rust-based library. The library does DRM for the plugin
and allows third-party software (Sonible plugins) to access our platform
securely.
...
to squeeze the algorithms into the smallest time/space footprint.
...
At [Focusrite/Novation](https://novationmusic.com/), we used it during a hackday to build
a synth with [tauri](https://tauri.app/) has a frontend and rume as the audio engine
