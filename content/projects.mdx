...
More of a banger track builder. It's unique approach to the embedded sample browser
...
realtime pitch and time shifting so you can mix-and-match
...
At [ROLI](https://roli.com/), I primarily worked on Dashboard. It's allows users
...
The application is in [JUCE](https://juce.com/). It was amazing working there, with the JUCE team!
...
[DREAM](https://dream.fr/) makes DSP chips for audio applications.
...
I did my Master's thesis work here, writing DSP algorithms.
Specifically various [Partitioned Convolution](https://ericbattenberg.com/school/partconvDAFx2011.pdf)
and [FFT](https://www.youtube.com/watch?v=spUNpyF58BY) implementations in C running on their ISA.

It's a small company but punches above its weight and
